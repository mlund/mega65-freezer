...
static constexpr uint8_t LINE_RETURN = 0x0D;
static constexpr uint8_t LINE_DELETE = 0x14;
 ...
 * neither wants one. */
static constexpr uint8_t LINE_FIRST_PRINTABLE = 0x20;
static constexpr uint8_t LINE_LAST_PRINTABLE = 0x7E;
